...
class Rank_SELayer(Module):
    def __init__(self, channel, reduction=16):
        super(Rank_SELayer, self).__init__()
        self.avg_pool = AdaptiveAvgPool2d(1)
        self.fc = Sequential(
            _LinearWithBias(channel, channel // reduction, bias=False),
            ReLU(inplace=True),
            _LinearWithBias(channel // reduction, channel, bias=False),
            nn.Softmax(dim=1),
        )
